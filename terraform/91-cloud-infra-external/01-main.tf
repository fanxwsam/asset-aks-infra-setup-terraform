terraform {
  ...
  backend "azurerm" {
    ...
    key = "terraform-cloud-infra-external.tfstate"
  }
}
...
module "cloud-infra" {
  ...
  # before create a new cluster, create the linux ssh access key
  ssh_public_key = "aks-external-sshkey.pub"

  # config the network
  aks_vnet_address_space = "10.0.0.0/16"
  aks_dns_service_ip = "10.0.240.10"
  aks_service_cidr = "10.0.240.0/20"
  aks_subnet_default_address_space = "10.0.0.0/20"
  aks_subnet_api_address_space = "10.0.16.0/20"
  aks_subnet_dbcluster_address_space = "10.0.32.0/20"
  aks_subnet_virtual_nodes_address_space = "10.0.48.0/20"
  ...
  # private DNS Zone
  resource_group_name_private_dns_zone = "dns-zone-private"
